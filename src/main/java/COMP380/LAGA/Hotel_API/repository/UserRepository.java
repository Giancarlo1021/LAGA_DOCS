...
/**
 * UserRepository is an interface that extends JpaRepository to provide
 * a means to access and manipulate User entities in the database.
 *
 * <p>By extending JpaRepository, UserRepository inherits all its methods
 * to perform CRUD operations on User entities. Additionally, JpaRepository
